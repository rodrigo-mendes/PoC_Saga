...
@Component
public class BookInvoiceItemsActivity implements JavaDelegate {
    private static final Logger LOG = LoggerFactory.getLogger(BookInvoiceItemsActivity.class);
    public static final String SERVICE_ACTION = "Book Items Invoice Activity";
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        LOG.info("execute {} - {}", ProcessConstants.ACTIVITY_NAME_BOOK_ITEMS_EXECUTE, SERVICE_ACTION);
        LOG.info("calling {} - {}", ProcessConstants.SERVICE_NAME_BOOK_ITEMS_EXECUTE, SERVICE_ACTION);
        ...
        ServiceRequest sr = new ServiceRequest().withId(UUID.randomUUID().toString())
                                                .withCreatedBy(ProcessConstants.ACTIVITY_NAME_BOOK_ITEMS_EXECUTE)
                                                .withCreatedDate(new Date())
                                                .withServiceName(ProcessConstants.SERVICE_NAME_BOOK_ITEMS_EXECUTE)
        ...
        execution.setVariable(ProcessConstants.STATUS_ITEMS_BOOKED, true);
