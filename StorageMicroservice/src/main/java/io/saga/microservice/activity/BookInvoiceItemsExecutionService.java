...
public class BookInvoiceItemsExecutionService implements EventHandler {
    private static final Logger LOG = LoggerFactory.getLogger(BookInvoiceItemsExecutionService.class);
