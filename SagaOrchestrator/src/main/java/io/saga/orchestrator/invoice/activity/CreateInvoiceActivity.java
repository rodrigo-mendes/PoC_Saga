...
@Component
public class CreateInvoiceActivity implements JavaDelegate {
    private static final Logger LOG = LoggerFactory.getLogger(CreateInvoiceActivity.class);
    public static final String SERVICE_ACTION = "Create Invoice Activity";
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        LOG.info("execute {} - {}", ProcessConstants.ACTIVITY_NAME_CREATE_INVOICE_EXECUTE, SERVICE_ACTION);
        LOG.info("calling {} - {}", ProcessConstants.SERVICE_NAME_CREATE_INVOICE_EXECUTE, SERVICE_ACTION);
        ...
        ServiceRequest sr = new ServiceRequest().withId(UUID.randomUUID().toString())
                                        .withCreatedBy(ProcessConstants.ACTIVITY_NAME_CREATE_INVOICE_EXECUTE)
                                        .withCreatedDate(new Date())
                                        .withServiceName(ProcessConstants.SERVICE_NAME_CREATE_INVOICE_EXECUTE)
        ...
        execution.setVariable(ProcessConstants.STATUS_INVOICE_PLACED, true);
