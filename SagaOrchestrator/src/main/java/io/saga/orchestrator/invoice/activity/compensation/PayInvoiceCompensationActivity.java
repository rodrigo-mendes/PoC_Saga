...
@Component
public class PayInvoiceCompensationActivity implements JavaDelegate {
    private static final Logger LOG = LoggerFactory.getLogger(PayInvoiceCompensationActivity.class);
    public static final String SERVICE_ACTION = "Pay Invoice Compensation Activity";
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        LOG.info("execute {} - {}", ProcessConstants.ACTIVITY_NAME_PAY_INVOICE_COMPENSATION, SERVICE_ACTION);
        LOG.info("calling {} - {}", ProcessConstants.SERVICE_NAME_PAY_INVOICE_COMPENSATION, SERVICE_ACTION);
        ...
        ServiceRequest sr = new ServiceRequest().withId(UUID.randomUUID().toString())
                                                .withCreatedBy(ProcessConstants.ACTIVITY_NAME_PAY_INVOICE_COMPENSATION)
                                                .withCreatedDate(new Date())
                                                .withServiceName(ProcessConstants.SERVICE_NAME_PAY_INVOICE_COMPENSATION)
