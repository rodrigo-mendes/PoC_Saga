...
public class TicketGenerationCompensationService implements EventHandler {
    private static final Logger LOG = LoggerFactory.getLogger(TicketGenerationCompensationService.class);
