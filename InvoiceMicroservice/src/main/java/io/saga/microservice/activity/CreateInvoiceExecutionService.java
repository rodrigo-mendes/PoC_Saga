...
public class CreateInvoiceExecutionService implements EventHandler {
    private static final Logger LOG = LoggerFactory.getLogger(CreateInvoiceExecutionService.class);
