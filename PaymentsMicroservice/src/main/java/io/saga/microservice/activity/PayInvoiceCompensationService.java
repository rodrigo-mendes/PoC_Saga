...
public class PayInvoiceCompensationService implements EventHandler {
    private static final String INVALID_REQ = "invalid";
    private static final String ROLLBACK_ACTION = "release";
    private static final Logger LOG = LoggerFactory.getLogger(PayInvoiceCompensationService.class);
