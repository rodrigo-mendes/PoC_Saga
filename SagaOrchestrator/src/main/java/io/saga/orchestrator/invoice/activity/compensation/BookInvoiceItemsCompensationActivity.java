...
@Component
public class BookInvoiceItemsCompensationActivity implements JavaDelegate {
    private static final Logger LOG = LoggerFactory.getLogger(BookInvoiceItemsCompensationActivity.class);
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        LOG.info("execute {} - {}", ProcessConstants.ACTIVITY_NAME_BOOK_ITEMS_COMPENSATION, SERVICE_ACTION);
        LOG.info("calling {} - {}", ProcessConstants.SERVICE_NAME_BOOK_ITEMS_COMPENSATION, SERVICE_ACTION);
        ...
        ServiceRequest sr = new ServiceRequest().withId(UUID.randomUUID().toString())
                                                .withCreatedBy(ProcessConstants.ACTIVITY_NAME_BOOK_ITEMS_COMPENSATION)
                                                .withCreatedDate(new Date())
                                                .withServiceName(ProcessConstants.SERVICE_NAME_BOOK_ITEMS_COMPENSATION)
