...
public class RabbitMqConfig {
    ...
    private List<String> compensationRoutings = new ArrayList<>();
    ...
    public List<String> getCompensationRoutings() {
        return this.compensationRoutings;
    }
    ...
    public String getCompensationQueueName() {
        return compensationRoutings.stream().findFirst().map(this::getQueue).orElse(DEFAULT_SERVICE_QUEUE);
    }
