...
public class CreateInvoiceCompensationService implements EventHandler {
    private static final Logger LOG = LoggerFactory.getLogger(CreateInvoiceCompensationService.class);

    @Override
    public ServiceResponse processRequest(ServiceRequest request) {
        LOG.info("############################## {} ################################", this.getClass().getName());
        LOG.info("RPC resquest - {} ", request);
